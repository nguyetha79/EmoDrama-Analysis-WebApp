App.Model = function () {
  ...
  let getSubEmoNegativeData = function(){
    let subEmoNegative = []
    let beingMoved = 0
    let pleasure = 0
    let anger = 0
    ...
    subEmoNegative = [["Sub Emotion", 'value'],
                        ["Being Moved", beingMoved],   
                        ["Pleasure", pleasure],
                        ["Anger", anger],
                        ["Fear", fear],
                        ...
                        ["Compassion", compassion],
                        ["Suffering", suffering]]
    return subEmoNegative           
  }

  let getMainEmoPositiveData = function(){
    let mainEmoPositiveData = []
    let pleasure = 0
    let rejection = 0
    let sufferingAEmpathy = 0
    let beingMoved = 0
    ...
    mainEmoPositiveData = [["Main Emotion", 'value', { role: 'style' }],
                            ["Pleasure", pleasure, 'color: #76A7FA'],
                            ["Rejection", rejection, 'color: yellow; opacity: 0.9'],
                            ["Suffering and Empathy", sufferingAEmpathy, 'color: #703593'],
                            ["Being Moved", beingMoved, 'color: #871B47'],
                            ["Affection", affection, 'fill-color: #BC5679'],
                            ["Anxiety", anxiety, 'opacity: 0.9']]
    return mainEmoPositiveData
  }

  let getSubEmoPositiveData = function(){
    let subEmoPositive = []
    let beingMoved = 0
    let pleasure = 0
    let anger = 0
...
let getMainEmoNegativeData = function(){
    ...
    that.getMainEmoPositiveData = getMainEmoPositiveData
    that.getSubEmoNegativeData = getSubEmoNegativeData
    that.getMainEmoNegativeData = getMainEmoNegativeData
    that.getSubEmoPositiveData = getSubEmoPositiveData
